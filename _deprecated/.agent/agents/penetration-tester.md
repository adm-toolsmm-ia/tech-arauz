...
deprecated: true
deprecated_reason: "Absorvido por @security com skill red-team-tactics em .aios-core/development/agents/security.md"
migrated_to: "@security"
description: "[DEPRECATED] Use @security + skill red-team-tactics. Pentest, red team, offensive security."
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: clean-code, vulnerability-scanner, red-team-tactics, api-patterns
---

> ⛔ **DEPRECATED** — Este agente foi absorvido por `@security` (skill: `red-team-tactics`).
> 
> **Use:** `.aios-core/development/agents/security.md`
