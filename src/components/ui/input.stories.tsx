...
export const Sizes: Story = {
  render: () => (
    <div className="w-80 space-y-4">
      <div>
        <label htmlFor="input-small" className="text-sm font-medium">
          Small
        </label>
      ...
      <div>
        <label htmlFor="input-large" className="text-sm font-medium">
          Large
        </label>
...
export const Form: Story = {
  render: () => (
    <div className="w-80 space-y-4">
      ...
      <div className="space-y-1">
        <label htmlFor="input-age" className="text-sm font-medium">
          Age
        </label>
...
export const Focused: Story = {
  render: () => <Input placeholder="This input shows focus state example" />,
};
