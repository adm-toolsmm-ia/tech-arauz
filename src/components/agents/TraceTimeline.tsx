        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              <div className={cn('flex h-7 w-7 shrink-0 items-center justify-center rounded-full border-2 bg-background', config.color === 'text-green-500' ? 'border-green-500' : config.color === 'text-red-500' ? 'border-red-500' : config.color === 'text-blue-500 animate-pulse' ? 'border-blue-500' : 'border-gray-300')}>
            ...
            <div className="flex-1 pb-2">
              ...
              <p className="text-xs text-muted-foreground capitalize">
                {step.status === 'completed' ? 'Concluído' :
                  ...
                  step.status === 'skipped' ? 'Ignorado' : 'Executando'}
              </p>
            </div>
          </div>
        );
