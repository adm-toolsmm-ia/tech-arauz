ç# EPIC 17 — Portal de Conhecimento & Visualização em Grafo
...
- [ ] Migration 075: `documents` table enhancements (reading_time, tags, summary, search_vector maintained by trigger, view_count, cover_image_url)
