...
export const SupplierCockpit360: React.FC<SupplierCockpit360Props> = ({
  supplier,
  onEdit,
  onDelete,
}) => {
  const roles = supplier.responsible_roles ?? [];
          ...
          <Card className="border-dashed">
            <CardContent className="grid gap-3 p-4 md:grid-cols-3">
              <div className="rounded-lg border p-3">
                ...
                <p className="mt-2 text-sm font-medium">{supplier.name}</p>
              </div>
              <div className="rounded-lg border p-3">
                <p className="text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
                  Responsáveis
              ...
              <div className="rounded-lg border p-3">
                ...
                <p className="mt-2 text-sm font-medium">Fornecedor operacional</p>
              </div>
            </CardContent>
          </Card>
