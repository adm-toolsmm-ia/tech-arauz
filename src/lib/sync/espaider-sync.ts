...
import {
  ...
  mapearOrcamento,
  mapearAprovador,
  // TODO: mapearTempoPermanencia e mapearHoraLancada removidos temporariamente (API 404)
  mapearRegistros,
...
function descricaoToDataset(descricao: string | null | undefined): EspaiderDataset | null {
  ...
  if (
    ...
    return 'Aprovadores';
  // TODO: TempoPermanencia e HorasLancadas removidas temporariamente (API 404 - investigar endpoint)
  return null;
}
    ...
    for (const urlFilho of urlFilhos) {
      ...
      try {
        ...
        if (dataset === 'Entregas') {
          ...
          // TODO: TempoPermanencia e HorasLancadas removidas temporariamente (API 404)
...
// =============================================================================
// TODO: TEMPORARIAMENTE REMOVIDO — TempoPermanencia
// =============================================================================
// Razão: API Espaider retorna 404 para endpoints BI_SOLICITACOES_PROJETOSESPAIDER_TEMPOSPERMANENCIA
// Estado: Aguardando investigação do endpoint correto
// Data Removido: 2026-03-19
//
// Função original: syncTempoPermanenciaFromRegistros()
// Padrão: idêntico ao syncApproversFromRegistros
// Tabela: project_tempo_permanencia
// Campo Chave: tenant_id, espaider_id (upsert conflict)
//
// Para reabilitar:
// 1. Verificar URL correta do endpoint na API Espaider
// 2. Descomentar função abaixo
// 3. Adicionar volta em descricaoToDataset() para reconhecer "TempoPermanencia"
// 4. Adicionar else if em executeSyncAll() para chamar syncTempoPermanenciaFromRegistros
// =============================================================================
/*
async function syncTempoPermanenciaFromRegistros(
  ...
  // [Função comentada — 165 linhas]
  // Código original removido em 2026-03-19 (GitHub issue #XXXX)
  // Tabela: project_tempo_permanencia
}
*/

// =============================================================================
// TODO: TEMPORARIAMENTE REMOVIDO — HorasLancadas
// =============================================================================
// Razão: API Espaider retorna 404 para endpoints BI_SOLICITACOES_PROJETOSESPAIDER_HORASLANCADAS
// Estado: Aguardando investigação do endpoint correto
// Data Removido: 2026-03-19
//
// Função original: syncHorasLancadasFromRegistros()
// Padrão: triple-lookup (espaider_id, pasta_consultivo_id, pasta_consultivo)
// Tabela: project_horas_lancadas
// Campo Chave: tenant_id, espaider_id (upsert conflict)
//
// Para reabilitar:
// 1. Verificar URL correta do endpoint na API Espaider
// 2. Descomentar função abaixo
// 3. Adicionar volta em descricaoToDataset() para reconhecer "HorasLancadas"
// 4. Adicionar else if em executeSyncAll() para chamar syncHorasLancadasFromRegistros
// =============================================================================
/*
async function syncHorasLancadasFromRegistros(
  ...
  // [Função comentada — 208 linhas]
  // Código original removido em 2026-03-19 (GitHub issue #XXXX)
  // Tabela: project_horas_lancadas
  // Implementa triple-lookup: espaider_id, pasta_consultivo_id, pasta_consultivo text
}
*/
