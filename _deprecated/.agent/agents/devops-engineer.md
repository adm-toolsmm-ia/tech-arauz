...
deprecated: true
deprecated_reason: "Substituído por @devops em .aios-core/development/agents/devops.md"
migrated_to: "@devops"
description: "[DEPRECATED] Use @devops. Deploy, server management, CI/CD, rollback, produção."
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: clean-code, deployment-procedures, server-management, powershell-windows, bash-linux
---

> ⛔ **DEPRECATED** — Este agente foi substituído por `@devops`.
> 
> **Use:** `.aios-core/development/agents/devops.md`
