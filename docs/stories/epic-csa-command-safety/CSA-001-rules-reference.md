# DevOps Execution Safety Rules (CSA-001) — Full Reference
...
> **Context rule for IDE:** `.claude/rules/devops-execution-safety.md` (summary). This document is the full specification.
