...
describe('deleteLmModelAction', () => {
  ...
  it('blocks deletion of system model', async () => {
    ...
    mockFrom
      .mockReturnValueOnce(profileChain({ tenant_id: 'tenant-1' })) // profiles
      .mockReturnValueOnce(
        profileChain({ id: 'm-1', tenant_id: 'tenant-1', name: 'GPT-4o', is_system: true }),
      );
  ...
  it('blocks deletion when model belongs to different tenant', async () => {
    ...
    mockFrom
      ...
      .mockReturnValueOnce(
        profileChain({ id: 'm-1', tenant_id: 'tenant-EVIL', name: 'GPT-4o', is_system: false }),
      );
  ...
  it('deletes model successfully and revalidates paths', async () => {
    ...
    mockFrom
      .mockReturnValueOnce(profileChain({ tenant_id: 'tenant-1' }))
      .mockReturnValueOnce(
        profileChain({ id: 'm-1', tenant_id: 'tenant-1', name: 'GPT-4o', is_system: false }),
      )
      .mockReturnValueOnce({
