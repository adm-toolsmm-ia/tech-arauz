...
- **Skills:** intelligent-routing, architecture, parallel-agents, plan-writing, clean-code
- **Triggers:** Qualquer pedido do usuário
- **Preconditions:** Nenhuma
- **Outputs:** Strategy document, Task Force definition, final validation, memory log
...
- **Skills:** vulnerability-scanner, red-team-tactics, authentication patterns
